...
class DatasetProcess(Dataset):
    def __init__(self, root_path, flag='train', size=None,
        ...
        self.paired_data = get_paired_data(self.root_path)
        self.train_loader, self.test_loader = get_dataloader(paired_data)
        
    def get_paired_data(self, root_path):
    ...
    def get_dataloader(self, paired_data):
